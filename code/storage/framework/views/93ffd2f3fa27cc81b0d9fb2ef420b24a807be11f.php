                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                ...
                                <?php echo e(Form::label('type', 'Type', ['class' => 'col-sm-2 col-form-label text-center'])); ?>
                                ...
                                <?php echo e(Form::label('type', 'Number Of Unit', ['class' => 'col-sm-2 col-form-label text-center'])); ?>

                                <div class="col-sm-4">



                                    <?php echo e(Form::number('NumberOfUnits', '', ['class' => 'form-control', 'placeholder' => 'Number Of Unit', 'id' => 'num_of_unit', 'required' => true])); ?>
                            ...
                            <div class="form-group row">
                                ...
                                <?php echo e(Form::label('type', 'Converted Figure', ['class' => 'col-sm-2 col-form-label text-center'])); ?>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <?php echo e(Form::text('Converted Figure', '', ['class' => 'form-control', 'placeholder' => 'Converted Figure', 'id' => 'converted_figure', 'readonly' => true])); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wrteam-dev/ebroker/resources/views/Calculator/calculator.blade.php ENDPATH**/ ?>