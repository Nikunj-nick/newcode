                    ...
                    <div id="inbox" class="contacts-outter-wrapper tab-pane active">
                        ...
                        <div class="contacts-outter">
                            <ul class="list-unstyled contacts">
                                <?php $__currentLoopData = $user_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(empty($value->receiver)): ?>
                                        <li data-toggle="tab" data-target="#inbox-message-1"
                                            id="<?php echo e('tabs' . $value->sender->id); ?>"
                                            onclick="setallMessage(<?php echo e($value->property_id); ?>, <?php echo e($value->sender->id); ?>);"
                                            style="display: flex;">

                                            <img alt="" class="img-circle medium-image"
                                                src="<?php echo e($value->sender->profile ? $value->sender->profile : 'https://www.nicepng.com/png/detail/128-1280406_view-user-icon-png-user-circle-icon-png.png'); ?>">

                                            <div class="vcentered info-combo">
                                                <h3 class="no-margin-bottom name"> <b><?php echo e($value->sender->name); ?></b> </h3>

                                                <h5> <?php echo e($value->property->title); ?></h5>
                                            </div>
                                ...
                                <?php $__currentLoopData = $user_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if(empty($value->sender)): ?>
                                        <li data-toggle="tab" data-target="#inbox-message-1"
                                            id="<?php echo e('tabs' . $value->receiver->id); ?>"
                                            onclick="setallMessage(<?php echo e($value->property_id); ?>, <?php echo e($value->receiver->id); ?>);"
                                            style="display: flex;">

                                            <img alt="" class="img-circle medium-image"
                                                src="<?php echo e($value->receiver->profile ? $value->receiver->profile : 'https://www.nicepng.com/png/detail/128-1280406_view-user-icon-png-user-circle-icon-png.png'); ?>">

                                            <div class="vcentered info-combo">
                                                <h3 class="no-margin-bottom name"> <b><?php echo e($value->receiver->name); ?> </b></h3>
                                    ...
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <?php $__currentLoopData = $otherusers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    
                                    <li data-toggle="tab" data-target="#inbox-message-1"
                                        id="<?php echo e('tabs' . $value['customer_id']); ?>"
                                        onclick="setallMessage(<?php echo e($value['proeperty_id']); ?>, <?php echo e($value['customer_id']); ?>);"
                                        style="display: flex;">

                                        <img alt="" class="img-circle medium-image"
                                            src="<?php echo e($value['profile'] ? $value['profile'] : 'https://www.nicepng.com/png/detail/128-1280406_view-user-icon-png-user-circle-icon-png.png'); ?>">

                                        <div class="vcentered info-combo">
                                            <h3 class="no-margin-bottom name"> <b><?php echo e($value['name']); ?></b> </h3>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wrteam-dev/ebroker/resources/views/chat/index.blade.php ENDPATH**/ ?>