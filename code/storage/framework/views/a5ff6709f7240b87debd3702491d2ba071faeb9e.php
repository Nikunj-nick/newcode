                ...
                <div class="card-body">
                    ...
                    <div class="row form-group">
                        <div class="col-12 d-flex justify-content-end">
                            <a href="<?php echo e(route('customer-privacy-policy')); ?>"col-sm-12 col-md-12 d-fluid
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wrteam-dev/ebroker/resources/views/settings/privacy-policy.blade.php ENDPATH**/ ?>