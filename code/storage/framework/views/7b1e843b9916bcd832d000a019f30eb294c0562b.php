        ...
        <section class="section">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <table class="table-light" aria-describedby="mydesc" class='table-striped'
                                        id="table_list" data-toggle="table" data-url="<?php echo e(url('user_reports_list')); ?>"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="myModalLabel1"><?php echo e(__('Edit Type')); ?></h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            <form action="<?php echo e(url('report-reasons-update')); ?>" class="form-horizontal"
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12 ">
                                        <div class="form-group mandatory">
                                            <label for="edit_reason" class="form-label col-12"><?php echo e(__('Reason')); ?></label>

                                            <textarea name="edit_reason" id="edit_reason" class="form-control" placeholder=<?php echo e(__('Reason')); ?> required></textarea>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary waves-effect waves-light"
                                id="btn_submit"><?php echo e(__('Save')); ?></button>
                            </form>
                        </div>
                    </div>
                </div>
            ...
            <div id="ViewPropertyModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1"
                ...
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="myModalLabel1"><?php echo e(__('View Property')); ?></h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row ">
                                <div class="col-md-6 col-12 ">
                                    <div class="col-md-12 col-12 form-group">
                                        <label for="title"
                                            class="form-label col-12 text-center"><?php echo e(__('Title')); ?></label>
                                ...
                                <div class="col-md-6 col-12 ">
                                    <div class="row ">
                                        ...
                                        <div class="col-md-4 col-12 form-group">
                                            <label for="city"
                                                class="form-label col-12 text-center"><?php echo e(__('City')); ?></label>
                                        ...
                                        <div class="col-md-4 col-12 form-group">
                                            <label for="state"
                                                class="form-label col-12 text-center"><?php echo e(__('State')); ?></label>
                                            <input class="form-control " placeholder="State" id="state" readonly
                                                type="text">
                                        </div>
                                        <div class="col-md-4 col-12 form-group">
                                            <label for="country"
                                                class="form-label col-12 text-center"><?php echo e(__('Country')); ?></label>
                            ...
                            <div class="row ">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 form-group">
                                            <label for="property_type"
                                                class="form-label col-12 text-center"><?php echo e(__('Property Type')); ?></label>
                                            <input class="form-control " placeholder="Property Type" id="property_type"
                                                readonly type="text">
                                        </div>
                                        <div class="col-md-6 col-12 form-group">
                                            <label for="category"
                                                class="form-label col-12 text-center"><?php echo e(__('Category')); ?></label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="row">
                                        <div class="col-md-6 col-12 form-group">
                                            <label for="price"
                                                class="form-label col-12 text-center"><?php echo e(__('Price')); ?></label>
                                            <input class="form-control " placeholder="Price" id="price" readonly
                                                type="text">
                                        </div>
                                        <div class="col-md-6 col-12 form-group">
                                            <label for="property_type"
                                                class="form-label col-12 text-center"><?php echo e(__('Rent Duration')); ?></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12 form-group">
                                            <label for="client_address"
                                                class="form-label col-12 text-center"><?php echo e(__('Client Address')); ?></label>
                                        ...
                                        <div class="col-md-6 col-12 form-group">
                                            <label for="address"
                                                class="form-label col-12 text-center"><?php echo e(__('Address')); ?></label>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <label for="description"
                                        class="form-label col-12 text-center"><?php echo e(__('Description')); ?></label>
                            ...
                            <div class="row mt-1">
                                <div class="col-md-6 col-12">
                                    <label for="description"
                                        class="form-label col-12 text-center"><?php echo e(__('Title Image')); ?></label>

                                    <img src="" alt="" id="title_image" height="50%" width="50%">
                                </div>
                                <div class="col-md-6 col-12">
                                    <label for="description"
                                        class="form-label col-12 text-center"><?php echo e(__('3D Image')); ?></label>

                                    <img src="" alt="" id="3d_image">
                                </div>
                            </div>
                            <label for="description"
                                class="form-label col-12 text-center"><?php echo e(__('Galllary Images')); ?></label>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wrteam-dev/ebroker/resources/views/reports/user_reports.blade.php ENDPATH**/ ?>