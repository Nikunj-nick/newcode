        ...
        <div class="card">
            ...
            <div class="card-header">
                <div class="divider">
                    <div class="divider-text">
                        <h4><?php echo e(__('Create Facility')); ?></h4>
                    </div>
                </div>
            </div>
            ...
            <div class="card-content">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <?php echo Form::open(['files' => true, 'data-parsley-validate']); ?>


                            <div class="row">
                                <div class="col-sm-12 col-md-4 form-group mandatory">

                                    <?php echo e(Form::label('type', __('Facility Name'), ['class' => 'form-label text-center'])); ?>


                                    <?php echo e(Form::text('parameter', '', ['class' => 'form-control', 'placeholder' => 'Facility', 'data-parsley-required' => 'true'])); ?>

                                </div>

                                <div class="col-md-4 col-sm-12 form-group mandatory">

                                    <?php echo e(Form::label('type', __('Type'), ['class' => 'form-label text-center'])); ?>
                                    ...
                                    <select placeholder="select" name="options" id="options"
                                        ...
                                        <option selected='false'><?php echo e(__('Select Type')); ?></option>
                                ...
                                <div class="col-sm-12  d-flex justify-content-end pt-3">
                                    <?php echo e(Form::submit(__('Save'), ['class' => 'btn btn-primary me-1 mb-1', 'id' => 'btn_submit'])); ?>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <table class="table table-borderless" aria-describedby="mydesc" class='table-striped'
                            id="table_list" data-toggle="table" data-url="<?php echo e(url('parameter-list')); ?>"
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col" data-field="type_of_parameter" data-sortable="true">
                                        <?php echo e(__('Type')); ?></th>
                                    <th scope="col" data-field="value" data-sortable="true"><?php echo e(__('Value')); ?></th>

                                    <?php if(has_permissions('update', 'type')): ?>
                                        <th scope="col" data-field="operate" data-sortable="false"><?php echo e(__('Action')); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel1"><?php echo e(__('Edit Facility')); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="<?php echo e(url('parameter-update')); ?>" class="form-horizontal" enctype="multipart/form-data"
                        ...
                        <div class="row form-group mandatory">
                            ...
                            <?php echo e(Form::label('type', 'Type', ['class' => 'col-12 form-label mt-3'])); ?>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wrteam-dev/ebroker/resources/views/parameter/index.blade.php ENDPATH**/ ?>