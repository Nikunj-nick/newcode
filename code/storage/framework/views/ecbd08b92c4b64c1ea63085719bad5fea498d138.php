        ...
        <div class="card">
            ...
            <div class="card-content">
                <div class="card-body">
                    <div class="row">
                        <div class="col-12">
                            <?php echo Form::open(['files' => true, 'data-parsley-validate', 'url' => route('outdoor_facilities.store')]); ?>

                            <div class="row">
                                <div class="col-sm-12 col-md-4 form-group mandatory">
                                    <?php echo e(Form::label('type', __('Place Name'), ['class' => 'form-label text-center'])); ?>

                                    <?php echo e(Form::text('facility', '', ['class' => 'form-control', 'placeholder' => 'Place Name', 'data-parsley-required' => 'true'])); ?>
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <table class="table table-borderless" aria-describedby="mydesc" class='table-striped' id="table_list"
                            data-toggle="table" data-url="<?php echo e(url('facility-list')); ?>" data-click-to-select="true"
                            ...
                            <thead class="thead-dark">
                                <tr>
                                    ...
                                    <th scope="col" data-field="image" data-formatter="imageFormatter"
                                        data-sortable="false"><?php echo e(__('Image')); ?></th>

                                    <?php if(has_permissions('update', 'type')): ?>
                                        <th scope="col" data-field="operate" data-sortable="false"
                                            data-events="actionEvents"><?php echo e(__('Action')); ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel1"><?php echo e(__('Edit Near By Place')); ?></h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="<?php echo e(url('facility-update')); ?>" class="form-horizontal" enctype="multipart/form-data"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wrteam-dev/ebroker/resources/views/OutdoorFacilities/index.blade.php ENDPATH**/ ?>