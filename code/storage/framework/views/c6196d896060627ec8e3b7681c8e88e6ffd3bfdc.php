    ...
    <div class="row">
        ...
        <section class="section">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <form action="<?php echo e(route('report-reasons.store')); ?>" class="needs-validation" method="post"
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-12">
                                        <label class="form-label"><?php echo e(__('Reason')); ?></label> <span
                                            class="text-danger">*</span>
                                        <textarea name="reason" class="form-control" placeholder=<?php echo e(__('Reason')); ?> required></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <table class="table-light" aria-describedby="mydesc" class='table-striped'
                                        id="table_list" data-toggle="table" data-url="<?php echo e(url('report-reasons-list')); ?>"
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wrteam-dev/ebroker/resources/views/reports/index.blade.php ENDPATH**/ ?>