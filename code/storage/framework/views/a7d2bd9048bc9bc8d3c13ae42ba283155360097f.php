...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'installer::components.link','data' => ['href' => route('LaravelWizardInstaller::install.server')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('installer::install', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wrteam-dev/ebroker/vendor/dacoto/laravel-wizard-installer/resources/views/steps/welcome.blade.php ENDPATH**/ ?>