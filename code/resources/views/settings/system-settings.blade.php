                            ...
                            <div class="card-body">
                                <div class="form-group mandatory">
                                    ...
                                    <div class="row">
                                        ...
                                        <label class="col-sm-5 form-check-label mt-3">{{ __('Change Icon Colors to theme Color?') }}</label>
                                        ...
                                        {{-- <label class="col-sm-3 form-check-label mt-3 ">{{ __('SEO Settings') }}</label>

                                        <div class="col-sm-1 mt-3">
                                            <div class="form-check form-switch ">

                                                <input type="hidden" name="seo_settings" id="seo_settings"
                                                    value="{{ system_setting('seo_settings') != '' ? system_setting('seo_settings') : 0 }}">
                                                <input class="form-check-input" type="checkbox" role="switch"
                                                    {{ system_setting('seo_settings') == '1' ? 'checked' : '' }}
                                                    id="switch_seo_settings">
                                                <label class="form-check-label mandatory"
                                                    for="switch_seo_settings"></label>
                                            </div>
                                        </div> --}}
                                    </div>
