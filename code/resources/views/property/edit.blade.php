                ...
                <div class="card-body" style="height: 549px;">
                    ...
                    <div class="col-md-12 col-12 form-group mandatory" id='duration'>
                        ...
                        <select name="price_duration" id="price_duration"class="choosen-select form-select form-control-sm" data-parsley-minSelect='1'>
                            <option value="Daily" {{ $list->rentduration == 'Daily' ? 'selected' : '' }}>Daily </option>
                            <option value="Monthly" {{ $list->rentduration == 'Monthly' ? 'selected' : '' }}>Monthly </option>
            ...
            <div class="card">
                ...
                <div class="row card-body">
                    ...
                    <div class="col-md-6 col-sm-12 form-group">
                        ...
                        <textarea id="edit_meta_title" name="edit_meta_title" class="form-control" oninput="getWordCount('edit_meta_title','edit_meta_title_count','12.9px arial')" rows="2" {{ system_setting('seo_settings') != '' && system_setting('seo_settings') == 1 ? 'required' : '' }} style="height: 75px">{{ $list->meta_title }}</textarea>
                        <br>
                    ...
                    @endif
                        ...
                        <input type="file" name="meta_image" id="meta_image" class="filepond" {{ system_setting('seo_settings') != '' && system_setting('seo_settings') == 1 ? 'required' : '' }}>
                    </div>
                    ...
                    <div class="col-md-12 col-sm-12 form-group">
                        ...
                        <textarea id="edit_meta_description" name="edit_meta_description" class="form-control" oninput="getWordCount('edit_meta_description','edit_meta_description_count','12.9px arial')" rows="3" {{ system_setting('seo_settings') != '' && system_setting('seo_settings') == 1 ? 'required' : '' }}>{{ $list->meta_description }}</textarea>
                        <br>
                    ...
                    <div class="col-md-12 col-sm-12 form-group">
                        ...
                        <textarea name="Keywords" id="" class="form-control" rows="3" {{ system_setting('seo_settings') != '' && system_setting('seo_settings') == 1 ? 'required' : '' }}>{{ $list->meta_keywords }}</textarea>
                        ...
                        <div class='col-md-6'>
                            <div class="row">
                                ...
                                <div class="col-md-6 form-group mandatory">
                                    ...
                                    {{ Form::text('country', isset($list->country) ? $list->country : '', ['class' => 'form-control ', 'placeholder' => 'country', 'id' => 'country', 'required' => true]) }}
                                </div>

                                {{-- State --}}
                                <div class="col-md-6 form-group mandatory">
                                    {{ Form::label('state', __('State'), ['class' => 'form-label col-12 ']) }}
                                    {{ Form::text('state', isset($list->state) ? $list->state : '', ['class' => 'form-control ', 'placeholder' => 'State', 'id' => 'state', 'required' => true]) }}
                                </div>
                                ...
                                <div class="col-md-12 col-12 form-group mandatory">
                                    ...
                                    {{ Form::textarea('client_address', isset($list->client_address) ? $list->client_address : (system_setting('company_address') ?? ""), ['class' => 'form-control ', 'placeholder' => 'Client Address', 'rows' => '4', 'id' => 'client-address', 'autocomplete' => 'off', 'required' => 'true']) }}
                                </div>
                        ...
                        <div class="col-md-3 col-sm-12 card">
                            ...
                            @if ($list->threeD_image)
                                <div class="card1 3d_img">
                                    <img src="{{ $list->threeD_image }}" alt="Image" class="card1-img" id="3d_img">
                                </div>
                            @endif
                        </div>
